...
let uniqueSetList1 = list1.filter(uniqName => !list2.includes(uniqName));

let uniqueSetList2 = list2.filter(uniqName => !list1.includes(uniqName));

let commonNames = list1.filter(uniqName => list2.includes(uniqName));

console.log(uniqueSetList1);
